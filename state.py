...
class Frame(object):
    ''' Represents the frame of a stack frame or of the entire program. '''
...
class InterpreterState(object):
    ...
    def __init__(self, module=None, frame=None, global_frame=None, last_block=None):
        self.update(module, frame, global_frame, last_block)

    def update(self, module=None, frame=None, global_frame=None, last_block=None):
        if module:
            self.module = module
        if frame:
    ...
    def lookup_var(self, var, ignore_err=False):
        ...
        elif self.global_frame.has_key(var.addr):
            return self.global_frame.get_variable(var.addr)
        elif not ignore_err:
    ...
    def set_var(self, var, new_value):
        ...
        elif self.global_frame.has_key(addr):
            self.global_frame.set_variable(addr, new_value)
        else:
            print "[ERROR]: Unknown variable. Exiting."
